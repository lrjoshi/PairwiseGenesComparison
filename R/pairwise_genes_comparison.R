...
pairwise_genes_comparison <- function () {

#importing files using file.choose option
print ("Remeber the order you upload your files. The output will have suffix 1 and 2 according the order you upload your files.")
print ("Import first file")
file1 <- readLines(file.choose(new=F))

print ("Import second file")
file2 <- readLines(file.choose(new=F))
